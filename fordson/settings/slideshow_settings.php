...
// Mihir adding 4th slide for HPCL news 31 Oct 2018


// This is the descriptor for slide
$name = 'theme_fordson/slide4info';
$heading = get_string('slide4info', 'theme_fordson');
$information = get_string('slide4infodesc', 'theme_fordson');
$setting = new admin_setting_heading($name, $heading, $information);
$page->add($setting);
// Slide title
$name = 'theme_fordson/slide4title';
$title = get_string('slidetitle', 'theme_fordson');
$description = get_string('slidetitle_desc', 'theme_fordson');
$default = '';
$setting = new admin_setting_configtext($name, $title, $description, $default);
...
//Slide Description
$name = 'theme_fordson/slide4content';
$title = get_string('slidecontent', 'theme_fordson');
$description = get_string('slidecontent_desc', 'theme_fordson');
$default = '';
$setting = new admin_setting_confightmleditor($name, $title, $description, $default);
...
// logo image.
$name = 'theme_fordson/slide4image';
$title = get_string('slideimage', 'theme_fordson');
$description = get_string('slideimage_desc', 'theme_fordson');
